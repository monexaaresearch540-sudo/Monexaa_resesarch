...
const heroVideo = process.env.PUBLIC_URL + '/assest/video/6912319_Motion_Graphics_Motion_Graphic_1080x1920.mp4';
import vectorLeft from '../assest/image/Vector 1.png';
import vectorRight from '../assest/image/Vector 2.png';

const CashPositional = () => {
  ...
  const schemaData = {
    ...
    "name": "Cash Positional Services",
    "description": "Premium Cash Positional trading tips for short to medium term delivery based trading.",
    "brand": {
      "@type": "Brand",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [{
      ...
      "item": "https://www.monexaaresearch.com/cash-positional"
    }]
  };
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <Helmet>
        <title>Cash Positional Tips | Monexaa Research - Best Short Term Delivery Calls</title>
        <meta name="description" content="Build wealth with Monexaa Research's Cash Positional tips. Expert short-term delivery calls for Equity Cash segment based on solid technical analysis." />
        <meta name="keywords" content="Cash Positional Tips, Equity Delivery Calls, Short Term Trading Tips, Swing Trading Stocks, Best Positional Tips Provider, Stock Market Investment Tips, Monexaa Research Cash" />
        <link rel="canonical" href="https://www.monexaaresearch.com/cash-positional" />
        
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.monexaaresearch.com/cash-positional" />
        <meta property="og:title" content="Cash Positional Tips | Monexaa Research - Best Short Term Delivery Calls" />
        <meta property="og:description" content="Join our premium Cash Positional services for high-accuracy delivery calls." />
      ...
      <div className="bg-[#FFF4E9] px-4 py-2">
        <div className="max-w-7xl mx-auto text-sm text-gray-600">
          ...
          <span className="font-semibold text-[#0F8B6E]">Cash Positional</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-12">
            <div className="space-y-6 text-center md:text-left z-10">
              <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold text-[#0b2b28] leading-tight fade-up animate-heading-loop">
                ...
                <span className="block sm:inline ml-2">Smart Way</span>
                <span className="block sm:inline ml-2">to</span>
                <br className="hidden sm:block" />
                <span className="inline-block mt-2">
                  Invest in
                  <span className="inline-flex items-center gap-2 ml-2 align-middle">
                    <strong className="text-accent-start animate-accent-loop">Equities</strong>
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-700 max-w-xl mx-auto md:mx-0 fade-up-1 leading-relaxed px-2 md:px-0">
                Build wealth with our expert Cash Positional strategies. We identify stocks with strong fundamentals and technical breakouts for short to medium term gains.
              </p>
              ...
              <div className="mt-8 flex flex-wrap justify-center md:justify-start gap-2 sm:gap-3 text-xs sm:text-sm text-gray-600 fade-up-3">
                <span className="bg-white/60 px-3 py-1.5 rounded-full border border-gray-200">#DeliveryCalls</span>
                <span className="bg-white/60 px-3 py-1.5 rounded-full border border-gray-200">#ShortTermInvestment</span>
                <span className="bg-white/60 px-3 py-1.5 rounded-full border border-gray-200">#EquityCash</span>
              </div>
            </div>
      ...
      <section id="services" className="py-12 md:py-20 bg-transparent">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-[#003E29] mb-4">Premium Cash Positional Services</h2>
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed px-2">
              Our Cash Positional Product is designed for investors who want to create wealth over time without monitoring the market every minute.
              We analyze <strong>Fundamentals, Sector Trends, and Technical Breakouts</strong> to provide you with high-quality delivery recommendations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-gray-50 p-6 sm:p-8 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">Trend Analysis</h3>
              <p className="text-sm sm:text-base text-gray-600">
                We identify stocks that are starting a new trend or breaking out from consolidation phases for maximum gains.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 sm:p-8 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">Capital Safety</h3>
              <p className="text-sm sm:text-base text-gray-600">
                Positional trading is less risky than intraday. We focus on stocks with strong support levels to minimize downside risk.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 sm:p-8 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">Holding Period</h3>
              <p className="text-sm sm:text-base text-gray-600">
                Our recommendations typically have a holding period of 3 to 15 days, giving your investments time to grow.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 bg-[#003E29] rounded-2xl p-6 sm:p-8 text-white text-center shadow-2xl transform hover:scale-[1.01] transition-transform max-w-4xl mx-auto">
            ...
            <div className="font-mono text-sm sm:text-lg md:text-xl bg-white/10 p-4 rounded-lg inline-block border border-white/20 break-all sm:break-normal">
              POSITIONAL : BUY TATASTEEL ABV 110 TGT 120/130 SL 100
            </div>
      ...
      <section id="payment-options" className="py-12 md:py-20 bg-transparent">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-600">Choose a plan that fits your investment horizon.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              { duration: "Monthly Plan", price: "₹ 15,000 + 18% GST", popular: false },
              { duration: "Quarterly Plan", price: "₹ 35,000 + 18% GST", popular: true },
              { duration: "Half-Yearly Plan", price: "₹ 50,000 + 18% GST", popular: false },
            ].map((plan, index) => (
              <div key={index} className={`relative bg-white rounded-2xl shadow-lg overflow-hidden border-2 ${plan.popular ? 'border-[#0F8B6E] transform md:-translate-y-4' : 'border-transparent'}`}>
                ...
                <div className="p-6 sm:p-8 text-center">
                  ...
                  <ul className="text-left space-y-3 mb-8 text-gray-600 text-xs sm:text-sm">
                    <li className="flex items-center gap-2"><FaCheckCircle className="text-green-500 flex-shrink-0" /> Short Term Delivery Recommendations</li>
                    <li className="flex items-center gap-2"><FaCheckCircle className="text-green-500 flex-shrink-0" /> Fundamental & Technical Picks</li>
                    <li className="flex items-center gap-2"><FaCheckCircle className="text-green-500 flex-shrink-0" /> Regular Follow-ups</li>
                  </ul>
                  <Link 
                    to="/payment" 
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            <div className="w-full md:w-1/2">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#003E29] mb-6">Golden Rules of Investing</h2>
              <p className="text-gray-600 mb-8 text-base sm:text-lg">
                Patience is the key to success in positional trading. Follow these rules to build wealth.
              </p>
              <div className="space-y-4 sm:space-y-6">
                {[
                  "Always diversify your portfolio.",
                  "Don’t panic during short-term market corrections.",
                  "Invest only surplus funds, not borrowed money.",
                  "Stick to the Stop Loss to protect capital.",
                  "Let your profits run and cut your losses early."
                ].map((rule, index) => (
            ...
            <div className="w-full md:w-1/2 bg-amber-50 rounded-3xl p-8 md:p-12 border border-amber-100">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Why Patience Matters?</h3>
      ...
      <section className="py-12 md:py-20 bg-transparent">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Common questions about our Cash Positional services.</p>
          </div>
            ...
            {[
              {
                ...
                a: "We recommend a minimum capital of ₹1,00,000 to diversify across multiple stocks."
              },
              {
                q: "What is the holding period?",
                a: "The holding period typically ranges from 3 days to 15 days, depending on the target achievement."
              },
              {
                q: "How many recommendations can I expect?",
                a: "You can expect 3-5 high-quality positional recommendations per week."
              },
              {
